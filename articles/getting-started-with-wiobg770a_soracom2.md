...
emoji: "🛠"
type: "tech"
topics: ["WioBG770A", "SORACOM", "LTE", "IoT"]
published: false
---
...
概要編で把握したアーキテクチャを前提に、本編では `cellular_basic.ino` の実装を土台にしながら BG770A の初期化、SORACOM への接続、Grove モジュールの入出力までを一気通貫で整理します。WioCellular/WioNetwork API の呼び出し順を把握しつつ、実機デバッグや省電力の第一歩まで掘り下げていきましょう。
